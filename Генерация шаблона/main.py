...
from template import create_square_template_1, create_square_template_2, create_portrait_template_2
...
aspect_ratios = {'square': {'size':(1024, 1024), 'funcs':[create_square_template_1, create_square_template_2]},
                 'portrait': {'size':(768, 1024), 'funcs':[create_portrait_template_1, create_portrait_template_2]},
...
# create_portrait_template_2('generated_images/portrait_back', obj_file_path, (768, 1024), fonts, colors)
